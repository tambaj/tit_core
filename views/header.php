...
<head>
  ...
  <title><?= (isset($this->title)) ?$this->title: 'tit_core'; ?></title>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo URL; ?>public/plugins/summernote/summernote-bs4.css">
  ...
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo URL; ?>public/plugins/datatables/dataTables.bootstrap4.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo URL; ?>public/dist/css/adminlte.min.css">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?php echo URL; ?>public/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo URL; ?>memb" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo URL; ?>offer/formcreate" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Offer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo URL; ?>offer" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Offers</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo URL; ?>payment" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Payments</p>
                </a>
              </li>
          ...
          <li class="nav-header"><a href="<?php echo URL; ?>dashboard/logout">Logout</a></li>
          <li class="nav-item">
        </ul>
      </nav>
      <!-- /.sidebar-menu -->
